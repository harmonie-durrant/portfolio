            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content w-screen flex-col content-evenly justify-evenly lg:flex-row-reverse">
                    ...
                    <div className="flex flex-col">
                        ...
                        <img
                            src="https://skillicons.dev/icons?i=c,cs,cpp,html,css,js,nodejs,react,next,tailwind,threejs,mysql,flutter,discordjs,py,lua,bash,md&perline=9"
                            alt="Skill Icons"
                            className="mt-8 max-w-[80%] mx-auto lg:mx-0"
                        />
                    </div>
                </div>
            </div>
