  ...
  return (
    <>
      ...
      <div id="about" className="">
        <h2 className="text-3xl font-bold text-center mt-10 mb-4">About Me</h2>
              ...
              return (
                <li key={i}>
                    ...
                    {event.description}
                  {
                    (event.skills) ? (
                        <>
                          <div className="text-lg font-black">Tools used:</div>
                          {
                            event.skills.map((skill, i) => (
                                <div key={(i+1)*2500} className="badge badge-primary badge-outline mr-2">{skill}</div>
                            ))
                          }
                        </>
                      ) : (<></>)
